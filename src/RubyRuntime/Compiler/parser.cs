...
namespace Ruby.Compiler
{
    ...
    internal class YYLTYPE : IMerge<YYLTYPE>
    {
        internal int first_line;
        internal int first_column;
        internal int last_line;
        internal int last_column;
    ...
    internal partial class Parser
    {
        ...
        internal static Scope ParseString(Frame caller, Frame scope, string f, String s, int line)
        {
            Parser parser = new Parser();
            ...
            Scope tree = parser.ParseInput(f, line);
        ...
        internal Scope ParseInput(string f, int line)
        {
            //System.IO.FileInfo file = new System.IO.FileInfo(f);
            scanner.sourcefile = f;
        ...
        internal void CreateContext(Frame innerFrame)
        {
            ...
            foreach (Frame frame in outer)
            {
                ...
                if (frame.current_block != null)
                    ...
                    enter_scope(new DEFN(CurrentScope, frame.methodName(), null));
